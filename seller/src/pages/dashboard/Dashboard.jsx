...
navigate("/login")
  ...
  return (
    <div className={styles.dashboardContainer}>
      {/* SIDEBAR */}
      {isToggle? <div style={{width:"70px",height:"95dvh",position:"fixed",background:"none",padding:"20px"}}> <div style={{width:"70px",height:"70px",background:"gray", position:"absolute",bottom:"0px", borderRadius:"50%"}} onClick={()=>{setIsToggle(false)}}></div></div>:<aside className={styles.sidebar}>
